...
class AppBlogHomeModel {
  ...
  factory AppBlogHomeModel.fromMap(Map<String, dynamic> map) {
    return AppBlogHomeModel(
      id: map['id'] ?? '',
  ...
  factory AppBlogHomeModel.fromJson(String source) =>
      AppBlogHomeModel.fromMap(json.decode(source) as Map<String, dynamic>);
}
