                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _ResultPills(
                        resultado: resultado,
                        gene: doenca.gene,
                        variante: doenca.variante,
                      )
                          .animate(delay: 120.ms)
                          .fadeIn(duration: 380.ms)
                          .slideY(begin: 0.05, end: 0),
                      const SizedBox(height: 18),
                      if (doenca.sobre_doenca.isNotEmpty)
                        _SectionCard(
                          icon: Icons.menu_book_rounded,
                          color: AppColor.primary,
                          title: 'Sobre a doença',
                          body: doenca.sobre_doenca,
                        )
                            .animate(delay: 180.ms)
                            .fadeIn(duration: 380.ms)
                            .slideY(begin: 0.05, end: 0),
                      if (doenca.manifesta.isNotEmpty) ...[
                        const SizedBox(height: 12),
                        _SectionCard(
                          icon: Icons.access_time_rounded,
                          color: AppColor.orange,
                          title: 'Quando se manifesta',
                          body: doenca.manifesta,
                        )
                            .animate(delay: 220.ms)
                            .fadeIn(duration: 380.ms)
                            .slideY(begin: 0.05, end: 0),
                      ],
                      if (doenca.recomendacoes.isNotEmpty) ...[
                        const SizedBox(height: 12),
                        _SectionCard(
                          icon: Icons.favorite_rounded,
                          color: const Color(0xFFE85D75),
                          title: 'Recomendações',
                          body: doenca.recomendacoes,
                        )
                            .animate(delay: 260.ms)
                            .fadeIn(duration: 380.ms)
                            .slideY(begin: 0.05, end: 0),
                      ],
                      if (doenca.racas.isNotEmpty) ...[
                        const SizedBox(height: 12),
                        _SectionCard(
                          icon: Icons.pets_rounded,
                          color: AppColor.secondary,
                          title: 'Raças afetadas',
                          body: doenca.racas,
                        )
                      ...
                      if (doenca.referencias.isNotEmpty) ...[
                        const SizedBox(height: 12),
                        _SectionCard(
                          icon: Icons.link_rounded,
                          color: const Color(0xFF8B5CF6),
                          title: 'Referências',
                          body: doenca.referencias,
                        )
...
class _ResultPills extends StatelessWidget {
  final String resultado;
  final String gene;
